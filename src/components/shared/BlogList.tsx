  ...
  return (
    <>
      <div className="w-full flex flex-wrap justify-between items-center mb-5 sm:mb-0">
        {props.children}
        <div className="w-full sm:w-max h-11 px-4 flex justify-between items-center gap-4 rounded-full border-slate-400 border-2">
          <input type="search" name="param" placeholder="Filter" onChange={debouncer()} className="border-0 bg-transparent outline-none" />
