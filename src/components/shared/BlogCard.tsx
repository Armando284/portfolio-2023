...
export default function BlogCard(props?: Blog) {
  return (
    <a
      ...
      className="relative w-full h-full rounded-lg overflow-hidden flex flex-col md:flex-row justify-center items-center md:text-right transition-all ease-in-out shadow-slate-950 shadow-md md:shadow-none border-purple-700 border md:border-0 bg-purple-900/80 hover:bg-purple-900 p-4 ease-in-out duration-150">
      ...
      <div className="absolute md:relative w-full h-full flex flex-col justify-between items-start md:items-end md:gap-5 bg-gradient-to-b from-purple-950 to-transparent md:from-transparent circle-gradient after:from-cyan-500 after:to-cyan-50 after:-right-[5%] after:-bottom-1/2 after:opacity-40">
        ...
        <footer className="w-full h-auto p-4 flex justify-end gap-2 bg-purple-950 md:bg-transparent z-10">
