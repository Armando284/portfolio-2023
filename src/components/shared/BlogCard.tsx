...
export default function BlogCard(props?: Blog) {
  return (
    <a
      ...
      className="relative w-full h-full rounded-lg overflow-hidden flex flex-col md:flex-row justify-center items-center md:text-right transition-all ease-in-out shadow-slate-950 shadow-md md:shadow-none border-purple-700 border md:border-0 bg-purple-900/50 hover:bg-purple-900/80 p-4 ease-in-out duration-150">
