...
export const jobs: Job[] = [

  {
    ...
    finishAt: 'Current',
    description: `Updated company’s website framework, Angular, from version 10 to version 15 and deprecated dependencies. Improved performance by 15% by replacing or updating deprecated dependencies and refactoring old code into newer standards. Improved backward version compatibility and reduced merge conflicts by following a cascade versioning system of git branches for each version update`,
